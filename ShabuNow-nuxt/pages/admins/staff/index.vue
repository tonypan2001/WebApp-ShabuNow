    ...
    <div v-else>
      ...
      <div class="my-4">
        ...
        <div class="flex items-center">
          ...
          <label @click="selectRole('admin')" id="admin" for="admin-checkbox" class="flex items-center cursor-pointer ease-out duration-300 hover:border-red-500 ml-5 px-4 py-2 border rounded">
